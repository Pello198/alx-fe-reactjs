function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-4 sm:p-4 md:max-w-sm md:p-8 max-w-xs sm:max-w-sm mx-auto my-10 sm:my-16 md:my-20 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <img
        src="https://unsplash.com/photos/man-sitting-on-rock-surrounded-by-water--Q_t4SCN8c4"
        alt="User"
